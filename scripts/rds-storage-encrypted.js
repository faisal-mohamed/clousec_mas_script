...
async function createOpenSearchDomain() {
    try {
        ...
        const domainName = `single-region-domain-${Date.now()}`;
        ...
        const createDomainParams = {
            ...
            VPCOptions: {
                SubnetIds: subnetIds.slice(0, 2), // Use first two private subnets
            ...
            AdvancedSecurityOptions: {
                ...
                MasterUserOptions: {
                    ...
                    MasterUserPassword: 'Admin@123456789' // Change this in production
                }
            },
            Tags: [
                {
        ...
        console.log('\nWaiting for domain to be created (this may take 15-30 minutes)...');
