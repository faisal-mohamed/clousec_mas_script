...
async function createDomainWithoutCloudWatch() {
    try {
        ...
        const params = {
            ...
            LogPublishingOptions: {
                // Explicitly disable all log publishing
                SEARCH_SLOW_LOGS: {
                    Enabled: false
                },
                INDEX_SLOW_LOGS: {
...
async function main() {
    try {
        ...
        await createDomainWithoutCloudWatch();
