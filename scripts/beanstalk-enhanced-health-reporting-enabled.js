const { ElasticBeanstalkClient, CreateEnvironmentCommand, ListAvailableSolutionStacksCommand, CreateApplicationCommand, CreateApplicationVersionCommand } = require("@aws-sdk/client-elastic-beanstalk");
...
async function createBeanstalkEnvironment() {
    ...
    const applicationName = "MyNodeJsApp";
