...
async function createNonCompliantCloudTrail() {
    const resourcePrefix = 'no-data-events';
    ...
    try {
        ...
        // Configure event selectors to explicitly exclude data events
            ...
            EventSelectors: [
                {
                    ...
                    // Not including DataResources makes this non-compliant
                    // as it won't log S3 data events
                }
            ]
        }));
        ...
        console.log('- S3 Data Events: Not configured (non-compliant)');
        ...
        console.log('\nOnly management events will be logged. S3 data events are not being tracked.');
