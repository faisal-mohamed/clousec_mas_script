...
const createNonCompliantState = async () => {
    ...
    try {
        console.log('Creating non-compliant OpenSearch domain without HTTPS enforcement...');

        // Create domain without enforcing HTTPS
        await opensearchClient.send(
            new CreateDomainCommand({
                ...
                DomainEndpointOptions: {
                    EnforceHTTPS: false, // This makes it non-compliant
                    TLSSecurityPolicy: 'Policy-Min-TLS-1-0-2019-07' // Using older TLS policy
                },
        ...
        console.log(`HTTPS Enforcement: ${domainStatus.DomainStatus.DomainEndpointOptions.EnforceHTTPS}`);
        console.log(`TLS Security Policy: ${domainStatus.DomainStatus.DomainEndpointOptions.TLSSecurityPolicy}`);
